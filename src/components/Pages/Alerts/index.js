				...
				<article className="with-aside">
					...
					<section>
						...
						<section>
							...
							<section className="alert-form alert-form-information">
								<i className="fa fa-info-circle"></i>
								<p className="content">I'm a sentence on <strong>one line</strong> within an in-form alert.</p>
							</section>
							<section className="alert-form alert-form-information">
								<i className="fa fa-info-circle"></i>
								<p className="content">I'm some body text that gives the user some additional information about a question or an answer in a form.</p>
							</section>
						</section>
						<section>
							<h3>Warning alerts</h3>
							<section className="alert-form alert-form-warning">
								<i className="fa fa-info-circle"></i>
							...
							<section className="alert-form alert-form-warning">
								<i className="fa fa-info-circle"></i>
								<p className='content'>The sort code and account number don’t match. Check your details and try again</p>
							</section>
						</section>
					</section>
				</article>
